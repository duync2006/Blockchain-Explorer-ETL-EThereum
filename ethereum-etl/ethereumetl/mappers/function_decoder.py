...
class FunctionInputDecoder:
    def __init__(self, contract: Contract):
        ...
        # print("self.contract.abi: ", self.contract.abi)
        self.function_abis = [abi for abi in self.contract.abi if abi['type'] == 'function']
        # self._method_name = [abi["name"] for abi in self.contract.abi if ['type'] == 'function']
        self._sign_abis = {function_abi_to_4byte_selector(abi): abi for abi in self.function_abis}
        self._name_abis = {abi['name']: abi for abi in self.function_abis}

    # def decode_function_input(self, result: Dict[str, Any]):
    ...
    def decode_function_input(self, data: Union[HexStr, str], name: str = None) -> Dict[str, Any]:
